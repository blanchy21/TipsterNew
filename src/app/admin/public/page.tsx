...
const PublicAdminPage: React.FC = () => {
    ...
    // Load admin statistics (simplified)
    useEffect(() => {
        const loadStats = async () => {
            ...
            try {
                ...
                const [posts, users, comments, notifications] = await Promise.race([
                    dataPromise,
                    timeoutPromise
                ]) as any[];
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold text-white">Admin Dashboard (Public)</h1>
