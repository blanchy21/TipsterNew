                ...
                <div className="flex items-center justify-between p-6 border-b border-white/10">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-zinc-400">Sign in to access your profile</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                    ...
                    <div className="text-center space-y-4">
                        ...
                        <div className="flex gap-3 pt-4">
                            <button
                                ...
                                className="flex-1 px-4 py-3 rounded-lg bg-primary text-white hover:bg-primary-hover transition-colors flex items-center justify-center gap-2"
                            >
                            ...
                            <button
                                ...
                                className="flex-1 px-4 py-3 rounded-lg bg-white/5 text-zinc-300 hover:bg-white/10 transition-colors"
                            >
                                Sign Up
                            </button>
                        </div>
