            ...
            <div className={`bg-white/5 rounded-xl p-6 border border-white/10 ${className}`}>
                <div className="flex items-center justify-center py-8">
                    <div className="text-center">
                        ...
                        <p className="text-zinc-300">Loading analytics...</p>
                    </div>
                </div>
            </div>
        );
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                    ...
                    <div className="space-y-3">
                        {stats.topSports.length > 0 ? (
                            stats.topSports.map((sport, index) => (
                                <div key={sport.sport} className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        <span className="text-sm font-medium text-zinc-300">{sport.sport}</span>
                                        <span className="text-xs text-zinc-500">({sport.count} tips)</span>
                                    </div>
                            ...
                            <p className="text-zinc-400 text-sm">No sports data available</p>
                        )}
                    </div>
                </div>
                ...
                <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            <span className="text-zinc-300">Pending Verification</span>
                            <span className="text-yellow-400 font-medium">{stats.pendingTips}</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <span className="text-zinc-300">Total Wins</span>
                            <span className="text-green-400 font-medium">
                                {stats.totalWins}
                            </span>
                        </div>
                        <div className="flex items-center justify-between">
                            <span className="text-zinc-300">Total Losses</span>
                            <span className="text-red-400 font-medium">
                                {stats.totalLosses || 0}
                            </span>
                        </div>
                        <div className="flex items-center justify-between">
                            <span className="text-zinc-300">Verification Rate</span>
                    ...
                    <div className="h-64">
                        {stats.topSports.length > 0 ? (
                            ...
                            <div className="h-full flex items-center justify-center">
                                <div className="text-center">
                                    <PieChart className="w-12 h-12 text-zinc-400 mx-auto mb-2" />
                                    <p className="text-zinc-400">No sports data available</p>
                                </div>
                            </div>
                        )}
                    </div>
            ...
            <div className="bg-gradient-to-r from-amber-500/10 to-orange-500/10 rounded-xl p-6 border border-amber-500/20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div className="text-center">
                        ...
                        <div className="text-sm text-zinc-300">Total Wins</div>
                    ...
                    <div className="text-center">
                        ...
                        <div className="text-sm text-zinc-300">Total Losses</div>
                        <div className="text-xs text-zinc-400 mt-1">
                    ...
                    <div className="text-center">
                        ...
                        <div className="text-sm text-zinc-300">Sports Covered</div>
                        <div className="text-xs text-zinc-400 mt-1">
