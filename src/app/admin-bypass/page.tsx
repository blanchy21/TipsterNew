...
export default function BypassAdmin() {
    const [isLoading, setIsLoading] = useState(false);
    const [message, setMessage] = useState<{ type: 'success' | 'error'; text: string } | null>(null);
    const [activeTab, setActiveTab] = useState<'overview' | 'tips' | 'data'>('overview');
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h1 className="text-3xl font-bold text-white">Admin Panel (Bypass)</h1>
                    ...
                    <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-yellow-400">Bypassed</p>
                            </div>
                        ...
                        <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <a
                                    ...
                                    className="p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-colors border border-white/10"
                                >
                                    <h4 className="text-white font-medium mb-2">This Admin</h4>
                                    <p className="text-slate-400 text-sm">Refresh this admin panel</p>
                                </a>
                                <a
                                    href="/debug"
                                    className="p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-colors border border-white/10"
                                >
                                    <h4 className="text-white font-medium mb-2">Debug Page</h4>
                                    <p className="text-slate-400 text-sm">Access the debug page</p>
                                </a>
                            </div>
                        </div>
                    </div>
