...
const ADMIN_EMAILS = ['paulblanche@gmail.com', 'admin@tipsterarena.com', 'paddypower@gmail.com'];
...
function AdminLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-surface-0 to-surface-2">{children}</div>
  );
}
