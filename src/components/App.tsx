...
function AppContent() {
  ...
  return (
    <NotificationsProvider>
      <div className="h-screen flex flex-col overflow-hidden bg-gradient-to-br from-surface-0 via-surface-1 to-surface-0">
        <Suspense fallback={<div className="h-16 bg-surface-2 animate-pulse" />}>
          <MobileHeader
        ...
        <div className="flex-1 flex overflow-hidden max-w-[1360px] mx-auto w-full">
          ...
          {selected === 'admin' && isAdminAuthenticated ? (
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
              <Suspense fallback={<div className="flex-1 bg-surface-2 animate-pulse" />}>
                <Feed
                  posts={filteredPosts}
                  isLoaded={isLoaded}
                  query={query}
