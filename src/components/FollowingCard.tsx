...
export default function FollowingCard({ list, onToggle, onNavigateToProfile }: FollowingCardProps) {
  return (
    <section className="rounded-xl bg-white/[0.03] ring-1 ring-white/5 overflow-hidden flex flex-col max-h-96">
