...
export default function NotificationToast({
  ...
  return (
    <div
      className={`fixed top-4 right-4 z-50 max-w-sm w-full bg-[#0B0F14] border border-white/10 rounded-lg shadow-lg transform transition-all duration-300 cursor-pointer hover:bg-[#0B0F14]/90 ${isVisible
