        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/5 rounded-xl p-6 border border-white/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-neutral-300">
              <div>
                <p>
                  <strong>Users:</strong> 6 test users with different specializations
                </p>
                <p>
              ...
              <div>
                <p>
                  <strong>Following:</strong> Pre-configured relationships
                </p>
                <p>
                  <strong>Features:</strong> Complete profiles with bios and stats
                </p>
              </div>
            </div>
          </div>
