      ...
      <div className="mt-4 pt-4 border-t border-white/[0.04] flex flex-col gap-2">
        ...
        {isAdminEmail(user?.email) && (
          <button
            ...
            className="w-full inline-flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-xs text-amber-400/80 hover:text-amber-300 bg-amber-500/10 hover:bg-amber-500/20 transition-colors ring-1 ring-inset ring-amber-500/20"
            title="Admin Panel"
          >
